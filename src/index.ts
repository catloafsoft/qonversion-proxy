export interface Env {
  ...
  BLOCK_UNAUTHENTICATED_REQUESTS?: string;
}
...
export interface ExportedHandlerLike<TEnv> {
  fetch(
    request: Request,
    env: TEnv,
...
export function createProxyRequest(request: Request, env: Env): Request {
...
function buildLogContext(request: Request, env: Env): ProxyLogContext {
...
const worker: ExportedHandlerLike<Env> = {
